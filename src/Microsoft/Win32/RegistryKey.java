...
public class RegistryKey extends MarshalByRefObject implements IDisposable {
  ...
  public static RegistryKey FromHandle(SafeRegistryHandle handle) {
    try {
      Object res = Javonet.getType("RegistryKey").invoke("FromHandle", handle);
      if (res == null) return null;
      return new RegistryKey((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public static RegistryKey FromHandle(SafeRegistryHandle handle, RegistryView view) {
    try {
      Object res =
          Javonet.getType("RegistryKey").invoke("FromHandle", handle, NEnum.fromJavaEnum(view));
      if (res == null) return null;
      return new RegistryKey((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
